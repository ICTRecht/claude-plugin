...
**Toepasselijke wetgeving:** AVG, EU Data Act, Open Data Richtlijn, AI Act, NIS2, DSA, DMA,
Cyber Resilience Act, sectorspecifiek
**Actief in EU-markten:** ...
**Relevante producten/diensten:** AI-systemen, online platforms, connected products, IoT, etc.
**Data governance structuur:** wie is verantwoordelijk (bijv. CDO, DPO, compliance officer)
**Huidige verwerkingsregister:** aanwezig / in opbouw / ontbreekt
**Huidige compliance-status EU digitale regelgeving:** welke verordeningen al geïmplementeerd
of in uitvoering zijn (AI Act, NIS2, DSA, DMA, eIDAS 2.0, Cyber Resilience Act)
