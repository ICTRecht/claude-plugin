...
# /ictrecht-legal-counsel:vok-review
...
1. **Organisatiecontext laden** — probeer in volgorde:
   ...
   - Geen van deze beschikbaar → ga door met generieke AVG-standaardinstellingen en vermeld bovenaan de output: "ℹ️ Geen organisatieprofiel gevonden — output is generiek. Voer `/ictrecht-legal-counsel:cold-start-interview` uit voor gepersonaliseerde analyses."
...
Schrijf beoordeling naar `~/.claude/plugins/config/ictrecht-legal-counsel/outputs/vok-review-[datum]-[leverancier].md`.
