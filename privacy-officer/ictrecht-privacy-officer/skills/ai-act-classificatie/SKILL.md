...
> ℹ️ *Geen organisatieprofiel gevonden. Voer `/ictrecht-privacy-officer:cold-start-interview` uit voor gepersonaliseerde analyse. Nu wordt generieke AI Act classificatie toegepast.*
...
### Output
Sla de classificatie op naar `~/.claude/plugins/config/ictrecht-privacy-officer/outputs/ai-act-classificatie-[datum].md`.
