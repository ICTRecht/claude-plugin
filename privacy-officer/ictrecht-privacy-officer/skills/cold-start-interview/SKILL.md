...
Maak ook aan: `~/.claude/plugins/config/ictrecht-privacy-officer/outputs/`.
...
- `/ictrecht-privacy-officer:dpia` — DPIA uitvoeren
- `/ictrecht-privacy-officer:datalek` — datalek beoordelen
- `/ictrecht-privacy-officer:avg-rechten` — betrokkene verzoek behandelen
- `/ictrecht-privacy-officer:doorgifte` — internationale doorgifte controleren
- `/ictrecht-privacy-officer:grondslag` — verwerkingsgrondslag bepalen
- `/ictrecht-privacy-officer:vok-review` — verwerkersovereenkomst controleren
- `/ictrecht-privacy-officer:verwerkingsregister` — verwerkingsregister opstellen of reviewen
- `/ictrecht-privacy-officer:data-sharing` — data sharing agreement beoordelen of opstellen
- `/ictrecht-privacy-officer:data-governance` — data governance framework toetsen of ontwikkelen
- `/ictrecht-privacy-officer:ai-act-classificatie` — AI-systeem classificeren volgens de AI Act
